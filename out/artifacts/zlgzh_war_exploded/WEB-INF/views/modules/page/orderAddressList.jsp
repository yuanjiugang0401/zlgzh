		...
		<body class="body">
			...
			<ul class="list">
				<c:forEach items="${addressList}" var="address" varStatus="s">
					<a href="${ctx}/page/cartOrder/?addrId=${address.id}&goodsId=${goodsId}">
						<li class="item">
							<div class="item-t">
								<h4>
									${address.addrUser}&nbsp;&nbsp;${fn:substring(address.addrTel, 0, 3)}****${fn:substring(address.addrTel, 7, 11)}
								</h4>
								<a href="${ctx}/page/orderAddressInfo?id=${address.id}"><img src="${ctxStatic}/images/icon-edit.png">
								</a>
							</div>
							<p>
			...
			<div class="link">
				<a href="${ctx}/page/orderAddressInfo">添加收货地址</a>
			</div>
		</body>
</html>